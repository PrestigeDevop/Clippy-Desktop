...
Agent.prototype._setupEvents = function _setupEvents () {
	...
	//todo : add custom events (triggers QAS+talk)
};

Agent.prototype._onDoubleClick = function _onDoubleClick () {
    if (!this.play('ClickedOn')) {
        this.animate();
		console.log('ask chat gpt API endpoint ');
		console.log('exceute function using event  ');
...
var load = function load (name, successCb, failCb, base_path) {
    base_path = base_path || window.CLIPPY_CDN || './';
